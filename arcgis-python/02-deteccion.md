...
Su análisis utilizará imágenes multiespectrales Sentinel-2. Estas imágenes se componen de [13 bandas espectrales](https://sentinels.copernicus.eu/web/sentinel/technical-guides/sentinel-2-msi/msi-instrument), pero en este flujo de trabajo sólo utilizará 6 bandas específicas: Azul, Verde, Rojo, Rojo Cercano 1 (Red-Edge 1), Infrarrojo Cercano 2 (NIR), e Infrarrojo de Onda Corta 2 (SWIR-2). Las bandas se almacenan como archivos separados.
